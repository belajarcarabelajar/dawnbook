// MathJax 2 inline-math config: enable $...$ as inline delimiter.
// Must be defined BEFORE the MathJax script loads.
// pulldown-cmark (mdBook's markdown parser) strips \( as an escape sequence,
// rendering it as plain (, so \(...\) never reaches MathJax.
// Using $...$ avoids this because dollar signs are not markdown escape characters.
window.MathJax = {
    tex2jax: {
        inlineMath: [['$', '$'], ['\\(', '\\)']],
        displayMath: [['$$', '$$'], ['\\[', '\\]']],
