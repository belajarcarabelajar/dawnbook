...
- **Rule 7.7.5 — Dedicated Reference Chapter (For Future Books):** A dedicated chapter specifically for "Referensi" MUST be generated and appended at the end of the book. The subagent responsible for this chapter MUST invoke web search tools to find robust and trustworthy literature/references corresponding to the book's topic. **Strict Constraint:** The sources MUST be restricted EXCLUSIVELY to scientific journal articles and books to maintain high credibility. All references MUST be consistently formatted in APA Style 7th Edition. Additionally, any URLs or DOIs included in the references MUST be rendered as clickable Markdown links (e.g., `[https://doi.org/...](https://doi.org/...)` or `<https://doi.org/...>`). (This rule applies only to new books processed going forward; existing books are exempt).
